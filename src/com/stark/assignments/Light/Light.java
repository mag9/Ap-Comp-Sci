 package com.stark.assignments.Light;
...
public class Light
{
	...
	public Light(boolean o, boolean b, String c)
	{
            ...
            if("red".equals(cLower) || "green".equals(cLower) || "blue".equals(cLower))
            {
                this.color = cLower;
            } 
                else
	...
	public String toString()
	{
            ...
            {
                burnString = "burnt out";
            }
                else
                {
                    burnString = "not burnt out";
                }
            
		return onoff + " " + this.color + "\t" + burnString;
	}
	...
	public void setColor(String c)
	{
            ...
            if("red".equals(cLower) || "green".equals(cLower) || "blue".equals(cLower))
            {
                ...
                else if(!"red".equals(c) || !"green".equals(c) || "blue".equals(c))
                {
                    this.color = "white";
                }
	}
